...
namespace ComicBook
{
    public partial class MainPage : ContentPage
    {
                         ...
                         new Func<string>
                            (
                                 () =>
                                 {
                                     ...
                                     {
                                         case "Android":
                                             retval_client_id = "264896847730-4lf3icgdqmmde2r1v03465qvgu1n4208.apps.googleusercontent.com";
                                             break;
                                         case "iOS":
                                             retval_client_id = "264896847730-9nval9q4ojrvj6kst4ac1hhb6doioe86.apps.googleusercontent.com";
                                             break;
                                         case "Windows":
                            ...
                            (
                                 () =>
                                 {
                                     ...
                                     switch (Xamarin.Forms.Device.RuntimePlatform)
                                     {
                                         case "Android":
                                             uri =
                                                 "com.googleusercontent.apps.264896847730-4lf3icgdqmmde2r1v03465qvgu1n4208:/oauth2redirect"
                                                 //"com.googleusercontent.apps.1093596514437-d3rpjj7clslhdg3uv365qpodsl5tq4fn:/oauth2redirect"
                                                 ;
                                             break;
                                         case "iOS":
                                             uri =
                                                 "com.googleusercontent.apps.264896847730-9nval9q4ojrvj6kst4ac1hhb6doioe86:/oauth2redirect"
		...
		{
            Navigation.PushModalAsync(new LoggedInPage(loggedIn));
		}
